            ...
            tabs: JSON.stringify([
                {
                    title: '基础信息',
                    component: '',
                    props: { appCode: 'gsxjydgl', pageCode: 'gsStudentChangeTypeBasicPage', type: 'page' },
                },
                {
                    title: '申请表单配置',
                    component: '',
                ...
                },
                {
                    ...
                    props: {
                        appCode: 'gsxjydgl',
                        pageCode: 'gsStudentChangeTypeUpdateFieldPage',
                        type: 'page',
                    },
                },
            ])
        ...
        editYdlxDialog: function (id, dm, title) {
            ...
            self.$request({
                ...
                data: {
                    ...
                    flowEntryDtoFilter: { appCode: "gsxjydgl", moduleCode: "", processDefinitionKey: "flow" + dm + "__" + appcode }
                }
            }).then(res => {
                if (res.code === "0" && res.data.rows.length > 0) {
                    ...
                    self.globalVars.relatedFields = JSON.stringify({
                        ...
                        flowPageId: entryId,
                        modelCode: 'gsstudentchangeapply',
                        appCode: appcode,
                        bizFlag: 'gsStudentChange'
                    });
                    self.$page('modelAdvTable').setTableZoom(false);
