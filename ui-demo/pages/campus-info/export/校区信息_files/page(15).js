define(function (require) {
    ...
    return {
        ...
        pageCreated: function () {
            this.globalVars.tipField = 'studenteapub.xm';
        ...
        action_show_dialog: function (event) {
            ...
            if (targetBtn.id == 'addBtn') {
                // 新增时可以修改
                this.$setModelConfig(formId, { "eastudentchangelimit.xsid": { "form.readonly": false } });
                ...
                // 编辑时不可以修改
                this.$setModelConfig(formId, { "eastudentchangelimit.xsid": { "form.readonly": true } });
                ...
                this.getFormInfo(row.id).then((res) => {
                    ...
                    let displayStr = res['studenteapub.xh'] + ' ' + res['studenteapub.xm']
                    this.$setModelVal("modelForm", 'eastudentchangelimit.xsid_name', displayStr);
                });
        ...
        exportBtn_click: function (event) {
            var self = this;
            // let rows = this.misPage('modelAdvTable').getCheckboxAllRecords();
            // let ids = rows.map((item) => item['eastudentchangelimit.id']);
        ...
        selectPeople(formData) {
            ...
            this.$setVal("adv-choice_jopl33uv", formData['eastudentchangelimit.xsid'] || '')
        },
        ...
        */
        ...
        //     let displayStr = ''
        //     this.$setModelVal("modelForm", 'eastudentchangelimit.xsid', formValItem)
        //     people.forEach(item => {
